...
<html>
	...
	<title>HIJELIA &mdash; Accueil</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Vetement" />
	<meta name="author" content="Marc BALAGUER & Lilya RAHBI" />
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<p>Voici la selection des produits pouvant vous intéresser.</p>
				</div>
			</div>
			<div class="row">
					...
					<div class="display-tc">
						<div class="col-md-3 col-sm-6 animate-box">
							<div class="feature-center">
								...
								<span class="counter-label">Pays</span>
						...
						<div class="col-md-3 col-sm-6 animate-box">
							<div class="feature-center">
								...
								<span class="counter-label">Clients sastifaits</span>
							</div>
						</div>
						<div class="col-md-3 col-sm-6 animate-box">
							<div class="feature-center">
						...
						<div class="col-md-3 col-sm-6 animate-box">
							<div class="feature-center">
								...
								<span class="counter js-counter" data-from="0" data-to="24" data-speed="5000" data-refresh-interval="200">1</span>
								<span class="counter-label">h / 24 h</span>
	...
	<div id="fh5co-started">
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Newsletter</h2>
					<p>Inscrivez-vous pour recevoir les dernières nouvelles et mises à jour directement dans votre boîte de réception</p>
				</div>
			</div>
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2">
					<form class="form-inline">
						...
						<div class="col-md-6 col-sm-6">
							<button type="submit" class="btn btn-default btn-block">Inscription</button>
						</div>
					</form>
				</div>
			</div>
