...
<html>
	...
	<title>HIJELIA &mdash; Livraison</title>
		...
		<div class="container">
			<div class="row row-pb-md">
				<div class="col-md-4 fh5co-widget">
					<h3>HIJELIA.</h3>
					<p>Boutique islamique : de prêt à porter femme musulmane modest fashion.</p>
				</div>
				...
				<div class="col-md-2 col-sm-4 col-xs-6 col-md-push-1">
					<ul class="fh5co-footer-links">
						...
						<li><a href="notice.html">Mentions legales</a></li>
					</ul>
				</div>
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						<small class="block">&copy; 2021 BALAGUER Marc & RABHI Lilya(HIJELIA). Tous droits réservés.</small> 
						<small class="block">Designed by <a href="www.linkedin.com/in/marc-balaguer-301423140 " target="_blank">M.BALAGUER</a> Photos par : <a href="#" target="_blank">L.RABHI</a> &amp; <a href="#" target="_blank">Photographe</a></small>
					</p>
					<p>
